...
#define DECLARE_TYPE_BODY(ModuleObjName, module_obj_name, MODULE_OBJ_NAME) 					\
	...
	inline ModuleObjName* MODULE_OBJ_NAME(const Object *self) { 							\
		return (ModuleObjName*)cast(module_obj_name##_get_type(), self); } 					\
	inline ModuleObjName##Class* MODULE_OBJ_NAME##_CLASS(const ObjectClass *klass) { 		\
		return (ModuleObjName##Class*)cast((module_obj_name##_class_get_type()), klass); }  \
	inline ModuleObjName##Class* MODULE_OBJ_NAME##_GET_CLASS(const ModuleObjName *self) { 	\
	...
	inline bool IS_##MODULE_OBJ_NAME##_CLASS(const ModuleObjName##Class *klass) { 			\
